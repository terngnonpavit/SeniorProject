...
$npdf->AddPage();
$npdf->SetThaiFont();
$npdf->SetFont('THSarabunNew');
$txt = $npdf->conv("สวัสดีชาวโลก");
$npdf->WriteHTML("form<br><p align='center'>$txt</p>and add a horizontal rule:<br><hr>");
$npdf->Output();
